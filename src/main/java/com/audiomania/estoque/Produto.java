...
// Classe principal que gerencia a conexão e operações com o banco de dados
        ...
        while (true) {
            ...
            switch (opcao) {
                ...
                case 2:
                    ...
                    Produto produto = gerenciador.buscarProdutoPorId(idBusca);
                    if (produto != null) {
                ...
                case 4:
                    ...
                    Produto produtoAtualizar = gerenciador.buscarProdutoPorId(idAtualizar);
                    if (produtoAtualizar != null) {
                        ...
                        gerenciador.atualizarProduto(produtoAtualizar);
                    } else {
                        System.out.println("Produto não encontrado.");
                    }
                    break;
